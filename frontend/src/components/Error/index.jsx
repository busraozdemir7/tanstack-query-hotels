...
const Error = ({ info, queryKey }) => {
    ...
    const retry = () => queryClient.invalidateQueries({ queryKey: [queryKey] });
    ...
    return (
        <>
            ...
            <div className="flex justify-center mt-5">
                <button onClick={retry} className="border hover:bg-zinc-200 px-4 py-1 rounded-md">Tekrar Dene</button>
            </div>
        </>
    )
};
